...
const WA_GROUP_LINK = "http://go.aarzooshah.com/whatsapp";
      ...
      >
        ...
        <div className="flex justify-center mb-5">
          <div className="h-16 w-16 flex items-center justify-center rounded-full bg-[#ffffff14]">
            <CheckCircle2 className="h-10 w-10" style={{ color: COLORS.yellow }} />
          </div>
        </div>

        {/* ✅ Heading */}
        <h1 className="text-2xl sm:text-3xl font-extrabold mb-3" style={{ color: COLORS.cream }}>
          Thank You For Registering!
        </h1>

        {/* ✅ Subtext */}
        <p className="text-base leading-relaxed mb-6" style={{ color: COLORS.cream, opacity: 0.9 }}>

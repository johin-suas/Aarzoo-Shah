      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 py-12 md:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)] md:px-6 md:py-16">
        ...
        >
          ...
          <motion.p variants={fadeUp(0.1)} className="mt-6 text-base leading-7 text-neutral-800 md:text-lg">
            I’m a passionate changemaker on a mission to help people break free from limitations
            and create a life of purpose, confidence, and success.
          </motion.p>

          <motion.p variants={fadeUp(0.15)} className="mt-4 text-base leading-7 text-neutral-800 md:text-lg">
            Through coaching, speaking, and transformational programs, I guide individuals to unlock
            their potential and step into their highest selves.
          </motion.p>

          <motion.p variants={fadeUp(0.2)} className="mt-4 text-base leading-7 text-neutral-800 md:text-lg">
            Over the years, I've helped people gain clarity, break barriers, and turn their deepest
            desires into tangible results.
          </motion.p>

          <motion.p variants={fadeUp(0.25)} className="mt-4 text-base leading-7 text-neutral-800 md:text-lg">
            If you’re looking to make a big change in your personal life, I am here to help you reach
            the highest levels of your creative potential and tap into the deepest wisdom within you.
          </motion.p>

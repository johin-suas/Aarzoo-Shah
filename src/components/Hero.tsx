...
const Hero = () => {
  ...
  const buildPayUrl = () => {
    ...
    const qs =
      ...
      `&gclid=${encodeURIComponent(attribution.gclid)}`;

    return `${RZP_PAGE_URL}${qs}`;
  };

  /** ✅ Submit → send to webhook → redirect */
  ...
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: COLORS.cream }}>
      ...
      >
        ...
        <motion.div variants={leftCol} className="space-y-4 lg:col-start-1 lg:row-start-2">
          ...
          <div className="flex justify-center">
            <a
              ...
              className="relative inline-flex rounded-full px-6 py-3 text-sm sm:text-base md:text-lg font-bold text-[#111]
        ...
        {/* ✅ SAME form + webhook + redirect (exactly same behavior) */}
          ...
          <div className="rounded-3xl border border-black/10 shadow-[0_14px_30px_rgba(0,0,0,0.12)] bg-[#f5b976] p-6 md:p-8">
            ...
            <form onSubmit={onSubmit} className="space-y-5" id="register">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full h-12 rounded-2xl font-extrabold text-black 
